...
class Ui_Form2(object):
    def setupUi(self, Form):
        ...
        self.queryTableModel.setTable('ImageLibrary')
        self.queryTableModel.select()
        self.queryTableModel.removeColumn(0)#移除第一列
        self.searchButtonClicked()
        self.tableView.setModel(self.queryTableModel)

        self.queryTableModel.setHeaderData(0, Qt.Horizontal, "图库名")
        self.queryTableModel.setHeaderData(1, Qt.Horizontal, "路径")
        ...
        self.addButton.clicked.connect(self.addImageLib)
    ...
    def addImageLib(self):
        self.addImageWindow = addImageWindow()
        if self.addImageWindow.exec_() == QtWidgets.QDialog.Accepted:
            pass

#重载添加图库对话框
class addImageWindow(QtWidgets.QDialog, Ui_Form_addImage):
